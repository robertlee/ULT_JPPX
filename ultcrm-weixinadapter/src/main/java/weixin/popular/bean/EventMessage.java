...
public class EventMessage {
	...
	public String toString() {
		...
		sb.append("toUserName:"+this.toUserName+",");
		sb.append("fromUserName:"+this.fromUserName+",");
		sb.append("createTime:"+this.createTime+",");
		sb.append("msgType:"+this.msgType+",");
		sb.append("event:"+this.event+",");
		sb.append("eventKey:"+this.eventKey+",");
		...
		sb.append("thumbMediaId:"+this.thumbMediaId+",");
		
		sb.append("location_X:"+this.location_X+",");
		sb.append("location_Y:"+this.location_Y+",");
